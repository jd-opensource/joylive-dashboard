...
const { t } = useI18n()
const columns = [
    { title: t('pages.invocation.form.name'), dataIndex: 'name', width: 180 },
    {
        title: t('pages.invocation.form.sourceApplicationId'),
        dataIndex: 'source_application_id',
        key: 'source_application_id',
        width: 150,
    },
    {
        title: t('pages.invocation.form.targetServiceId'),
        dataIndex: 'target_service_id',
        key: 'target_service_id',
        width: 150,
    },
    { title: t('pages.invocation.form.path'), dataIndex: 'path', width: 150 },
    { title: t('pages.invocation.form.method'), dataIndex: 'method', width: 100 },
    ...
    { title: t('pages.invocation.form.description'), dataIndex: 'description', ellipsis: true },
    {
