...
type PolicyCircuitBreak struct {
	...
	SpaceCode                   string          `json:"spaceCode" gorm:"size:255;not null;uniqueIndex:uniq_policy_circuit_break_name;comment:Microservice space code;"`         // Microservice space code
	SourceApplicationID         *string         `json:"sourceApplicationId,omitempty" gorm:"size:20;uniqueIndex:uniq_policy_circuit_break_name;comment:Source application ID;"` // Source application ID
	TargetServiceId             string          `json:"targetServiceId" gorm:"size:20;not null;uniqueIndex:uniq_policy_circuit_break_name;comment:Target service ID;"`          // Target service ID
