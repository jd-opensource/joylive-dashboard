...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ApplicationForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/resource/application-services": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ApplicationService"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ApplicationServiceForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/resource/application-services/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/resource/application-services/{id}/status": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ApplicationServiceStatusForm"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ServiceAlias"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ServiceAliasForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/resource/service-aliases/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/resource/service-groups": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ServiceGroup"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ServiceGroupForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/resource/service-groups/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.Service"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schema.ServiceForm"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_jd-opensource_joylive-dashboard_pkg_errors.Error": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer"
        ...
        "schema.Application": {
            ...
            "properties": {
                "alias": {
                    "description": "Application Chinese name",
                    "type": "string"
                },
                "created_at": {
        ...
        "schema.ApplicationService": {
            ...
            "properties": {
                "application": {
                    "description": "Application (auto-loaded association)",
                    "allOf": [
                        {
                            "$ref": "#/definitions/schema.Application"
                        }
        ...
        "schema.ApplicationServiceForm": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "Status: approved, rejected, pending",
                    "type": "string",
                    "maxLength": 20
                }
            }
        },
        "schema.ApplicationServiceStatusForm": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "schema.Service": {
            ...
            "properties": {
                ...
                "authorized": {
                    "description": "Parsed from Extra.authorized; not stored directly",
                    "type": "integer"
                },
                "created_at": {
                    "description": "Create time",
                ...
                "registration_type": {
                    "description": "Registration type: HTTP, RPC_APP, RPC_INTERFACE",
                    "type": "string"
                },
                "source": {
                    "description": "Data source: Local, JSF, JDAP",
        ...
        "util.ResponseResult": {
            ...
            "properties": {
                "data": {},
                "error": {
                    "$ref": "#/definitions/github_com_jd-opensource_joylive-dashboard_pkg_errors.Error"
                },
                "success": {
                    "type": "boolean"
                },
