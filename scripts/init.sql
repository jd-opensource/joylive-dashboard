...
(
  ...
  COLLATE = utf8mb4_bin COMMENT = '微服务空间';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '应用';
...
(
    ...
    `deleted_at`     timestamp                                             NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uniq_app_service` (`application_id`, `service_id`, `role`, `deleted`) USING BTREE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '应用服务关联';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '微服务';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '服务分组';
...
(
    ...
    `source_application` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin          DEFAULT NULL COMMENT '主调应用',
    ...
    `deleted_at`         timestamp                                              NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uniq_name` (`name`, `space_code`, `source_application`, `target_service_id`, `deleted`) USING BTREE,
    UNIQUE KEY `uniq_service` (`space_code`, `source_application`, `target_service_id`, `deleted`) USING BTREE
) ENGINE = InnoDB
  COLLATE = utf8mb4_bin COMMENT = '负载均衡策略';
...
(
    ...
    `deleted_at`         timestamp                                              NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uniq_name` (`name`, `space_code`, `source_application`, `deleted`) USING BTREE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '标签路由策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '服务限流策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '熔断降级策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '服务鉴权策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '服务认证策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '故障注入策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '调用策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '应用配置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '应用配置版本';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '配置变更单';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '配置灰度策略';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '配置模板';
...
(
    ...
    `deleted_at` timestamp                                             NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uniq_data_permission` (`type`, `data_id`, `user`, `tenant`, `role`, `deleted`) USING BTREE,
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '泳道组';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '泳道';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT = '泳道引流规则';
...
(
    ...
    `deleted_at`           timestamp    NULL     DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`),
    UNIQUE KEY `uniq_setting` (`key`, `space_code`, `application_id`, `component_version_id`, `setting_scope_id`, `type`, `deleted`),
    KEY `idx_space_code` (`space_code`),
    KEY `idx_application_id` (`application_id`),
    KEY `idx_type` (`type`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='基础配置';
...
CREATE TABLE IF NOT EXISTS `setting_scope` (
    ...
    DEFAULT CHARSET = utf8mb4
    COLLATE = utf8mb4_bin COMMENT ='配置域';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='Swagger API版本表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='API接口定义表';
